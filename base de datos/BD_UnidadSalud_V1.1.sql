...
alter table cita_medica_med add constraint FK_Relationship_58 foreign key (USU_ID)
      references usuarios_sistema (ID) on delete restrict on update restrict;

alter table cita_medica_med add constraint FK_Relationship_64 foreign key (PAC_ID)
      references paciente (ID) on delete restrict on update restrict;
