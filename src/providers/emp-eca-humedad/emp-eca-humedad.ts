...
export class EmpEcaHumedadProvider {
  ...
  deleteHumedadMax(): Observable<Eca>{
    ...
    let v =  this.http.get("http://186.87.66.4/DeleteEca?osid=1519735968&ecaName=EcaHumedadMaxima")
  ...
  deleteHumedadMin() : Observable<Eca>{
    //return this.http.get(this.ip + "/DeleteEca" + this.osid + "&ecaName=EcaTemperaturaMinima")
    return this.http.get("http://186.87.66.4/DeleteEca?osid=1519735968&ecaName=EcaHumedadMinima")
