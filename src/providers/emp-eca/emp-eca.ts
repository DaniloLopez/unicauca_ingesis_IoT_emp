...
export class EmpEcaProvider {
  ...
  deleteTemperaturaMax(): Observable<Eca>{
    ...
    let v =  this.http.get("http://186.87.66.4/DeleteEca?osid=1519735968&ecaName=EcaTemperaturaMaxima")
